                    ...
                    <div className="container-fluid" >
                        <div className="container">
                            <div className="row footer-links">
                                ...
                                <div className="col-sm-3 col-xs-6">
                                    ...
                                    <ul className="list-unstyled" >
                                        <li><a className={classes.aTag} className="mailus" href="../board-of-directors-bee-secure.html">Board of Directors</a></li>
                                        <li><a className={classes.aTag} className="mailus" href="../fair-practice-code-beesecure.html">Fair Practice Code</a></li>
                                        <li><a className={classes.aTag} className="mailus" href="../KYC_BeeSecure.html">List of KYC Documents</a></li>
                                        <li><a className={classes.aTag} className="mailus" href="../MITC.html">MITC for Home Loans</a></li>
                                        <li><a className={classes.aTag} className="mailus" href="../grievance-bee-secure.html">Grievance Redressal Policy</a></li>
                                        <li><a className={classes.aTag} className="mailus" href="../corporate_governance.html">Corporate Governance Guidelines</a></li>
                                        <li><a className={classes.aTag} className="mailus" href="../related-party-policy-bee-secure.html">Policy on Related Party Transactions</a></li>
                                        <li><a className={classes.aTag} className="mailus" href="../EGM-notice-bee-secure.html">Notices of General Meetings</a></li>
                                        <li><a className={classes.aTag} className="mailus" href="../term-appointment-ID.html">T&C Of The Appointment Of Independent Directors</a></li>

                                        <li><a className={classes.aTag} className="mailus" href="../resignation-notice-bee-secure.html">Resignation of Directors</a></li>
                                        <li><a className={classes.aTag} className="mailus" href="https://www.incred.com/docs/Whistle Blower Policy.pdf" >Whistle Blower Policy</a></li>
                                        <li><a className={classes.aTag} className="mailus" href="https://www.incred.com/docs/Policy for Determining Interest Rates, Processing & other Charges.pdf"
                                ...
                                <div className="col-sm-3 col-xs-6">
                                    <h5>EMAIL</h5>
                                    <ul className="list-unstyled">
                                        <li><a className={classes.aTag} className="mailus" href="mailto:care@incred.com">care@incred.com</a></li>
                                    </ul>
                                    <ul className="list-unstyled">
                                        <li>
                                    ...
                                    <div className="phone-number">
                                        <span className="phones"> <i className="fa fa-phone"></i></span>
                                        <a className={classes.aTag} href="tel:18605002192" >1860 500 2192</a>
                                        <ul className="list-unstyled list-inline">
                                            <li className="social"><a className={classes.aTag} href="https://twitter.com/InCredFin" ><i className="fa fa-twitter"></i></a></li>
                                            <li className="social"><a className={classes.aTag} href="https://www.facebook.com/InCredIndia/" ><i className="fa fa-facebook"></i></a></li>
                                            <li className="social"><a className={classes.aTag} href="https://www.linkedin.com/company/incred-finance/" ><i className="fa fa-linkedin"></i></a></li>
                                            <li className="social"><a className={classes.aTag} href="https://www.instagram.com/incredfin" ><i className="fa fa-instagram"></i></a></li>
                                            <li className="social"><a className={classes.aTag} href="https://www.youtube.com/channel/UCWDW_L_2lSaDAL4O5ghj7yg" ><i className="fa fa-youtube"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="row copy-right">
                            <div className="col-sm-12 copy-before">
                                ...
                                {/* <div className="col-md-8 text-right">InCred Financial Services Limited is a NBFC registered with the RBI <br />  InCred Housing Finance Private Limited
